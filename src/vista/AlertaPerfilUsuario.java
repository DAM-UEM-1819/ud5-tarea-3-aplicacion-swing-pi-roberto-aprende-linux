...
public class AlertaPerfilUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlertaPerfilUsuario frame = new AlertaPerfilUsuario();
	...
	public AlertaPerfilUsuario() {
		...
		HeaderPanel.add(lblTitulo);
		 ...
		 JButton btnCrearUsuario = new JButton("Confirmar Cambios");
		 btnCrearUsuario.setBounds(690, 672, 134, 40);
